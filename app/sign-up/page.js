...
function SignUpForm() {
  ...
  const handleEmailSignUp = async (e) => {
    ...
    if (authError) {
      ...
      // Check if session is already active (i.e. email confirmation disabled)
      if (data?.session) {
        router.push(next);
        router.refresh();
      } else {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-background">
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none overflow-hidden">
        <div className="absolute -top-[10%] -right-[10%] h-[300px] w-[300px] rounded-full bg-accent/20 blur-[100px]" />
        <div className="absolute -bottom-[10%] -left-[10%] h-[350px] w-[350px] rounded-full bg-primary/10 blur-[110px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Join the community and nurture your inner peace
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-border bg-card p-8 shadow-xl">
          {/* Error Banner */}
          {error && (
            <div className="mb-6 flex items-start gap-3 rounded-xl border border-destructive/20 bg-destructive/10 p-4 text-sm text-destructive font-medium">
          ...
          {/* Success Banner */}
          {successMessage && (
            <div className="mb-6 flex items-start gap-3 rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-4 text-sm text-emerald-600 dark:text-emerald-400 font-medium">
